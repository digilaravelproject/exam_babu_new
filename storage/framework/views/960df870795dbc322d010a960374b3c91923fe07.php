                                        ...
                                        <div class="mt-1">
                                            <select id="country" name="country" value="<?php echo e(old('country') ?? ($billing_information['country'] ?? null)); ?>" autocomplete="country" class="block w-full rounded-sm shadow-sm focus:ring-current focus:border-primary <?php echo e($errors->has('country') ? ' border-red-300' : 'border-gray-300'); ?>">
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($country['code']); ?>" <?php echo e($country['code'] == 'IN' ? 'selected' : ''); ?>><?php echo e($country['name']); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
...
<?php echo $__env->make('store.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/store/checkout/index.blade.php ENDPATH**/ ?>