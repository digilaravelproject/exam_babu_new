<?php if($homePageSettings->enable_footer): ?>
    <footer class="border-t text-dark bg-slate-900 border-slate-800">
        <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-16">

            <div class="flex flex-col items-center justify-center text-center">

                <div class="mb-6">
                    <img class="w-auto h-10" src="<?php echo e(asset('storage/'.$siteSettings['white_logo_path'])); ?>" alt="<?php echo e($siteSettings['app_name']); ?>">
                </div>

                <p class="max-w-2xl mx-auto mb-8 text-lg font-medium text-slate-400">
                    <?php echo e($siteSettings['tag_line']); ?>
                ...
                <?php if($footerSettings->enable_social_links): ?>
                    <div class="flex mb-10 space-x-6">
                        <?php $__currentLoopData = $footerSettings->social_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $socialLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($socialLink[1]): ?>
                                <a href="<?php echo e($socialLink[2]); ?>" target="_blank" class="transition-colors duration-200 transform text-slate-400 hover:text-dark hover:scale-110">
                ...
                <?php if($footerSettings->enable_links): ?>
                    <div class="flex flex-wrap justify-center gap-6 mb-8 text-sm font-medium">
                        <?php $__currentLoopData = $footerSettings->footer_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footerLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($footerLink[2]): ?>
                                <a href="<?php echo e($footerLink[1]); ?>" class="transition-colors text-slate-400 hover:text-dark">
                                    <?php echo e($footerLink[0]); ?>
                ...
                <div class="w-full pt-8 border-t border-slate-800">
                    <p class="text-sm text-slate-500">
                        &copy; <?php echo e(date("Y")); ?> <?php echo e(config('app.name')); ?>. <?php echo e($footerSettings->copyright_text); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/components/footer.blade.php ENDPATH**/ ?>