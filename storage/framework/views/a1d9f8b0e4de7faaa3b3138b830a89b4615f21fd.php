<?php $__env->startSection('header'); ?>
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-gray-900"><?php echo e(__('Update Syllabus')); ?></h1>
...
<?php $__env->startSection('content'); ?>
    <div class="py-8">
        ...
        <?php if(count($categories) > 0): ?>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div onclick="document.getElementById('form-<?php echo e($category['code']); ?>').submit();"
                        ...
                        <div class="relative p-8 flex flex-col items-center text-center h-full justify-center min-h-[180px]">
                            ...
                            <div class="flex items-center justify-center mb-5 text-blue-600 transition-transform duration-300 shadow-inner h-14 w-14 rounded-2xl bg-blue-50 group-hover:scale-110 group-hover:rotate-3">
                                <span class="text-2xl font-bold">
                                    <?php echo e(mb_substr($category['name'], 0, 1, 'UTF-8')); ?>
                            ...
                            <div class="flex flex-wrap justify-center gap-2">
                                <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-semibold bg-gray-100 text-gray-600 border border-gray-200 group-hover:bg-white group-hover:text-blue-600 group-hover:border-blue-200 transition-colors">
                                    <?php echo e($category['category'] ?? 'General'); ?>
                        ...
                        <form id="form-<?php echo e($category['code']); ?>" action="<?php echo e(route('update_syllabus')); ?>" method="POST" style="display: none;">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="category" value="<?php echo e($category['code']); ?>">
                        </form>
        ...
        <?php else: ?>
            <?php if (isset($component)) { $__componentOriginal33ee42b4e95f82f725467b8005ae0d408f76524a = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Card\EmptyData::class, []); ?>
<?php $component->withName('card.empty-data'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'No Syllabus Found','message' => 'We couldn\'t find any categories to display right now.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal33ee42b4e95f82f725467b8005ae0d408f76524a)): ?>
<?php $component = $__componentOriginal33ee42b4e95f82f725467b8005ae0d408f76524a; ?>
<?php unset($__componentOriginal33ee42b4e95f82f725467b8005ae0d408f76524a); ?>
<?php endif; ?>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/user/change_syllabus.blade.php ENDPATH**/ ?>