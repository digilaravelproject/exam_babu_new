<div class="w-full sm:w-80 relative bg-white border rounded-lg shadow-sm divide-y divide-gray-200 <?php echo e($plan['popular'] ? 'border-secondary' : 'border-gray-200'); ?>">
        ...
        <p class="mt-6">
            <?php if($plan['has_discount']): ?>
                <!--<span class="text-3xl font-bold text-gray-800"><span class="line-through"><?php echo e($plan['price']); ?></span> <?php echo e($plan['discounted_price']); ?></span>-->
                 <span class="text-3xl font-bold text-gray-800"><span class="line-through"><?php echo e($plan['total_price']); ?></span> <?php echo e($plan['discounted_price']); ?></span>

                
            <?php else: ?>
                <!--<span class="text-3xl font-bold text-gray-800"><?php echo e($plan['price']); ?></span>-->
                <span class="text-3xl font-bold text-gray-800"><?php echo e($plan['total_price']); ?></span>
    ...
    <div class="pt-6 pb-8 px-6">
        <!--<h3 class="font-medium text-gray-900 tracking-wide"><?php echo e($plan['duration']); ?> <?php echo e(__('Months')); ?>  <?php echo e(__('Unlimited Access')); ?></h3>-->
...
<?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Babu\Old_website\backp\resources\views/components/plan.blade.php ENDPATH**/ ?>