<section id="pricing" class="bg-gray-50 border-b border-gray-100">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:py-28 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            <h2 class="text-base text-3xl text-secondary font-semibold tracking-wide uppercase sm:text-4xl"><?php echo e(__('Pricing')); ?></h2>
...
<?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/components/pricing.blade.php ENDPATH**/ ?>