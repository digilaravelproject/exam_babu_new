<?php $__env->startSection('header'); ?>
    <h1 class="text-2xl font-bold tracking-tight text-gray-800"><?php echo e(__('My Practice Sessions')); ?></h1>
    ...
    <div class="py-6">
                                ...
                                <tr class="transition duration-150 ease-in-out hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-bold text-gray-900">
                                            <?php echo e($session->practiceSet->title ?? 'Practice Set'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-sm font-bold text-gray-900">
                                                <?php echo e($session->total_points_earned ?? 0); ?> Pts
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <a href="<?php echo e(route('practice_session_analysis', ['practiceSet' => $session->practiceSet->slug, 'session' => $session->id])); ?>"
        ...
        <?php else: ?>
            <div class="p-12 text-center bg-white border border-gray-300 border-dashed rounded-xl">
                ...
                <h3 class="text-lg font-medium text-gray-900"><?php echo e(__('No practice sessions found')); ?></h3>
                <p class="mt-1 text-gray-500">Start practicing to see your progress here.</p>
                <div class="mt-6">
                    <a href="<?php echo e(route('learn_practice')); ?>" class="font-medium text-blue-600 hover:text-blue-800">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/user/progress/practice.blade.php ENDPATH**/ ?>