...
<?php $__env->startSection('header'); ?>
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800"><?php echo e($type->name); ?></h1>
                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center justify-center w-10 h-10 font-bold text-blue-600 rounded-lg bg-blue-50">
                                <?php echo e(mb_substr($exam->title, 0, 1, 'UTF-8')); ?>
                        ...
                        <div class="flex items-center mb-6 space-x-4 text-xs text-gray-500">
                            ...
                            <span class="flex items-center">
                                ...
                                <?php echo e($exam->total_questions); ?> Qns
                            </span>
                        </div>

                        <?php if($exam->is_paid && !$subscription): ?>
                            <a href="<?php echo e(route('pricing')); ?>" class="block w-full px-4 py-2 font-bold text-center text-gray-800 transition bg-gray-100 rounded hover:bg-gray-200">
                                Unlock Premium
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('exam_instructions', ['slug' => $exam->slug])); ?>" class="block w-full px-4 py-2 font-bold text-center text-white transition bg-blue-600 rounded shadow-md hover:bg-blue-700 shadow-blue-500/30">
                                Start Practice
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/user/exams_by_type.blade.php ENDPATH**/ ?>