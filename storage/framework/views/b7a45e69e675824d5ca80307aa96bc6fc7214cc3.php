<?php $__env->startSection('header'); ?>
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-gray-800"><?php echo e(__('Dashboard')); ?></h1>
            <p class="mt-1 text-sm text-gray-500">Welcome back, <?php echo e(Auth::user()->first_name); ?> 👋</p>
        </div>
        <a href="<?php echo e(route('add_exams')); ?>" class="items-center hidden px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-blue-600 border border-transparent rounded-md sm:inline-flex hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25">
            Explore New Exams
        </a>
    </div>
    ...
    <div class="py-2">
                    ...
                    <?php $__currentLoopData = $userSubscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex flex-col h-full transition-all duration-300 transform bg-white border border-gray-100 shadow-sm group rounded-2xl hover:shadow-xl hover:-translate-y-1">
                            ...
                            <div class="flex items-start justify-between p-5 border-b border-gray-50 bg-gray-50/50 rounded-t-2xl">
                                <div>
                                    <h3 class="text-lg font-bold leading-tight text-gray-900"><?php echo e($subscription['plan']); ?></h3>
                                    <p class="mt-1 text-xs font-medium text-gray-500">Expires: <?php echo e($subscription['ends']); ?></p>
                                </div>
                            ...
                            <div class="flex-1 p-5">
                                <?php if(!empty($subscription['features'])): ?>
                                    ...
                                    <ul class="space-y-3">
                                        <?php $__currentLoopData = array_slice($subscription['features'], 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <li class="flex items-start text-sm text-gray-600">
                                                <svg class="flex-shrink-0 w-5 h-5 mr-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                                </svg>
                                                <span class="line-clamp-1"><?php echo e(__($feature['name'])); ?></span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(count($subscription['features']) > 4): ?>
                                            <li class="text-xs font-medium text-blue-500 pl-7">+ <?php echo e(count($subscription['features']) - 4); ?> more features</li>
                                        <?php endif; ?>
                                    </ul>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="p-5 pt-0 mt-auto">
                                <a href="<?php echo e(route('exam_dashboard')); ?>" class="block w-full px-4 py-3 font-semibold text-center text-white transition duration-200 bg-gray-900 shadow-md hover:bg-blue-700 rounded-xl group-hover:shadow-lg">
                                    Go to Exams
        ...
        <?php else: ?>
            <div class="p-12 text-center bg-white border border-gray-300 border-dashed shadow-sm rounded-2xl">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('add_exams')); ?>" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Digi_Laravel_Prrojects\Exam-Backup-Update\resources\views/user/dashboard.blade.php ENDPATH**/ ?>