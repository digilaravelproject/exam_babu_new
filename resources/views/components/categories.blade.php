            ...
            @foreach($categories as $category)
                <div class="w-full sm:w-64 p-4 rounded border hover:shadow-lg">
                    ...
                    <div class="mt-8 w-full sm:w-56 h-9">
                         <a href="{{ route('store.categories.show', $category->slug) }}" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 hover:opacity-90 flex items-center justify-center flex-1 h-full py-3 px-20 bg-primary border rounded border-primary">
